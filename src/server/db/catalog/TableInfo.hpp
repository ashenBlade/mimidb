...
class TableInfo {
  private:
    ...
    Oid _oid;
    // Tuple descriptor
    const access::TupleDescriptor *_descriptor;
    // All columns in table
    std::vector<ColumnInfo> _columns;

  public:
    TableInfo(Oid oid, const access::TupleDescriptor *descriptor, std::vector<ColumnInfo> columns)
    ...
    const access::TupleDescriptor *GetDescriptor() const { return this->_descriptor; }
